                ...
                <div class="flex items-center space-x-3 sm:space-x-4">
                    @auth
                                    ...
                                    <a href="{{ route('order.view') }}"
                                        class="inline-flex items-center rounded-md bg-gray-100 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-indigo-50 hover:text-indigo-600 border border-indigo-600 transition">
                                        My Orders
                                    </a>
